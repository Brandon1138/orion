...
export declare class GoogleCalendarAuth {
    private config;
...
/**
 * Default Google Calendar scopes for Phase 1A (read-only)
 */
export declare const DEFAULT_CALENDAR_SCOPES: string[];
/**
 * Create Google Calendar auth instance with default configuration
 */
export declare function createGoogleAuth(config: Partial<GoogleAuthConfig>): GoogleCalendarAuth;
